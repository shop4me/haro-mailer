...
def build_haro_query_id(request_text: str, outlet: str | None, deadline: str | None) -> str:
    basis = "||".join([normalize_text(request_text), normalize_text(outlet or ""), normalize_text(deadline or "")])
